...
def main():
    ...
    print("\n【Theme View Generation】")
    theme_view = ThemeViewService.generate_theme_view(insight_specs, role="self")
    theme_count = sum(len(items) for items in theme_view.values())
    print(f"✅ Theme view generated: {len(theme_view)} themes, {theme_count} lectures")
